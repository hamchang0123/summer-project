...
Currently, the dataset is unorderly. To summarise  should be grouped by agegroup and then by date.  
...
df_grp <- df_age3 %>%
  ...
  summarise(case = sum(case),
            .groups = 'drop')
  #case incidence in adults and children and adults by date
